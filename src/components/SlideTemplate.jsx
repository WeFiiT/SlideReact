...
function DecorTopRight() {
  return (
    <svg style={{ position: 'absolute', top: 0, right: 0, pointerEvents: 'none' }} width="220" height="200" viewBox="0 0 220 200" fill="none">
      <g opacity="0.18" stroke="#7dd3fc" strokeWidth="1.5">
        <line x1="220" y1="15" x2="170" y2="15" />
        <line x1="170" y1="15" x2="145" y2="40" />
        <line x1="145" y1="40" x2="145" y2="90" />
        <line x1="145" y1="65" x2="100" y2="65" />
        <line x1="220" y1="50" x2="185" y2="50" />
        <line x1="185" y1="50" x2="160" y2="75" />
        <line x1="160" y1="75" x2="160" y2="130" />
        <line x1="220" y1="90" x2="175" y2="90" />
        <line x1="175" y1="90" x2="155" y2="110" />
...
function DecorTopLeft() {
  return (
    <svg style={{ position: 'absolute', top: 0, left: 0, pointerEvents: 'none' }} width="180" height="160" viewBox="0 0 180 160" fill="none">
      <g opacity="0.18" stroke="#f97316" strokeWidth="1.5">
        <line x1="0" y1="18" x2="50" y2="18" />
        <line x1="50" y1="18" x2="75" y2="43" />
        <line x1="75" y1="43" x2="75" y2="85" />
        <line x1="75" y1="60" x2="120" y2="60" />
        <line x1="0" y1="55" x2="35" y2="55" />
        <line x1="35" y1="55" x2="60" y2="80" />
